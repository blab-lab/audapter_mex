...
private:
	...
	typedef enum {
		...
		NEG_INTENSITY_SLOPE_BELOW_THRESH = 12, // CWN add-on
		INTENSITY_FALL = 20,
		INTENSITY_FALL_NEG_SLOPE = 21,	// CWN add-on
		INTENSITY_RATIO_RISE = 30, 
		INTENSITY_RATIO_FALL_HOLD = 31,
		INTENSITY_RATIO_FALL_HOLD_NEG_SLOPE = 32, // CWN add-on
		INTENSITY_RATIO_RISE_WITH_FLOOR = 33, //CWN add-on
		INTENSITY_AND_RATIO_RISE_HOLD = 40 // CWN add-on
	} OST_MODE_NAME;
