...
## Special setup for Audapter versions b2.4 and older (before June 2026)
If you are intentionally using Audapter version b2.4 or older, you will also need to download and add to your MATLAB path the [blab-lab/commonmcode repository](https://github.com/blab-lab/commonmcode). Then, move the commonmcode folder to the bottom of your MATLAB path. The commonmcode repository should not be used at all for Audapter version b2.5 (June 2026) or later.
